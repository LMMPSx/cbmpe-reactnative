...
export default function NewOccurrenceScreen({ navigation, route }: any) {
    ...
    const handleSave = () => {
        // Validação mantida do campo protocolo (Protocolo obrigatório)
        ...
        // Em um projeto real, aqui você chamaria o service para salvar os dados (API)
    };
                ...
                <ScrollView contentContainerStyle={styles.scrollContent}>
                    ...
                    {step === 1 && (
                        <View style={styles.formSection}>
                            ...
                            {/* CAMPO RESPONSÁVEL COMO TEXT INPUT (ENTIDADE MANTIDA) */}
                            <TextInput
                                style={styles.input}
                    ...
                    {step === 2 && (
                        <View style={styles.formSection}>
                            ...
                            {/* CAMPO PROTOCOLO COMO TEXT INPUT (ENTIDADE MANTIDA) */}
                            <TextInput
                                style={styles.input}
